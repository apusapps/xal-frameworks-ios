...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FlatBuffers-ObjC/FlatBuffers_ObjC.framework"
  ...
  install_framework "${PODS_ROOT}/../../XALFrameworks/Frameworks/APSActivate.framework"
  install_framework "${PODS_ROOT}/../../XALFrameworks/Frameworks/APSAdjust.framework"
  install_framework "${PODS_ROOT}/../../XALFrameworks/Frameworks/APSAlex.framework"
  install_framework "${PODS_ROOT}/../../XALFrameworks/Frameworks/APSCloud.framework"
  install_framework "${PODS_ROOT}/../../XALFrameworks/Frameworks/APSCompression.framework"
  install_framework "${PODS_ROOT}/../../XALFrameworks/Frameworks/APSLibraryAdapter.framework"
  install_framework "${PODS_ROOT}/../../XALFrameworks/Frameworks/APSLogServer.framework"
